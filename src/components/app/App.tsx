...
function App() {
  ...
  const addObject = (name: any, value: any) => {
    if (name === "" || undefined)
      return alert(
        "Берега попутал? хочешь не дать название? может быть ты ещё и мир в гиену огненную подтолкнёшь? войну мировую устроишь, детишек сам лично задушишь и котят с щенятами зарубишь топором пока они скулят и зовут свою мамочку? а? если нет, то давай ка исправляйся и пиши всё по человечески, жестокий психопат. Мы тут таких как ты не любим, которые назавание объектам не дают"
      );
